...
class BSRoformer13a(nn.Module):
    def __init__(
        ...
        self.stft1 = Fourier(n_fft=512, hop_length=441)
        self.stft2 = Fourier(n_fft=2048, hop_length=441)
        self.stft3 = Fourier(n_fft=8192, hop_length=441)

        self.stft_to_image1 = StftToImage(
        ...
        self.stft_to_image2 = StftToImage(
            in_channels=self.input_channels * self.cmplx_num, 
            sr=sr, 
            n_fft=2048, 
            mel_bins=mel_bins,
        ...
        self.stft_to_image3 = StftToImage(
            in_channels=self.input_channels * self.cmplx_num, 
            sr=sr, 
            n_fft=8192, 
            mel_bins=mel_bins,
    ...
    def forward(self, mixture):
        ...
        if True:
            ...
            x = self.stft_to_image1.transform(x)
            # shape: (b, d, t, f)
