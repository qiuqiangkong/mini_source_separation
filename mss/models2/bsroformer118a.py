...
from mss.models2.attention117a import Block
from mss.models.rope import RoPE
from mss.utils import fast_sdr


class BSRoformer118a(nn.Module):
    def __init__(
        self,
        audio_channels=2,
        sample_rate=48000,
        ...
        **kwargs
        ...
        # Subband filter
        banks = mel_linear_banks_triangle(sample_rate, 118, max_half_bandwidth)
        ...
        self.unpatch1 = UnPatch(96, in_channels, (1, 1))
