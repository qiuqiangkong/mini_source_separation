...
from mss.models2.dsp3.banks import exp_linear_banks2
...
class BSRoformer115b(nn.Module):
    def __init__(
        self,
        audio_channels=2,
        sample_rate=48000,
        ...
        **kwargs
        ...
        # Subband filter
        banks = exp_linear_banks2(sample_rate, n_bands, max_half_bandwidth, q=1.08)
